...
while True:
    ...
    for point in cube_points:
        ...
        projection_matrix = make_projection_matrix_depth()
...
# Make simple projection matrix

def make_projection_matrix_simple():
    '''
...
def make_projection_matrix_depth():
    '''
    projection matrix with depth
    '''
    return [[1,0,0],
            [0,1,0],
            [0,0,0]]
